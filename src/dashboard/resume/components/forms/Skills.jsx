        ...
        <div className='card-premium p-10 mt-6 relative overflow-hidden group/form'>
            ...
            <div className='flex flex-col sm:flex-row justify-between items-center gap-6 mt-12 pt-10 border-t border-slate-100'>
                <div className='flex gap-4 w-full sm:w-auto'>
                    <Button variant="outline" onClick={AddNewSkills} className="text-brand-primary border-slate-200 hover:text-brand-primary hover:bg-brand-primary/5 hover:border-brand-primary rounded-2xl gap-2 flex-1 sm:flex-none h-12 px-6 font-bold shadow-sm transition-all"> 
